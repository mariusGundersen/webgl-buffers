...
export class RenderTexture extends Texture implements FrameBuffer {
  ...
  constructor(gl: WebGLRenderingContext, atomicBind: AtomicBind, width: number, height = width, parameters: TextureParameters = {}, blend = false) {
    super(gl, width, height, parameters);
